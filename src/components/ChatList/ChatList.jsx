...
export const ChatList = () => {
    ...
    return(
        <div className="chat-list">
            {myChats.map((c, index) => (
                <div className={`chat-list-item ${selectChat?.id === c.id ? 'selected-chat-item': ''}`} 

                    key={index} >

                    <div onClick={() => selectChatClick(c)} 
                                ...
                                <>
                                    ...
                                    <div className="chat-list-preview">
                                        ...
                                        <div className="preview-message">
                                            {c.last_message.attachments.length ? `${c.last_message.sender.username} sent an attachment` : 
